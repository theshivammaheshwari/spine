      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
          ...
          <p className="text-muted-foreground text-lg max-w-lg mb-8">
            Professional chiropractic care by Dr. Harshvardhan Chaturvedi — licensed chiropractor, spine correction expert &amp; osteopath in Jaipur. No surgery, no medicine.
          </p>
          <div className="flex flex-wrap gap-4">
            <a href="tel:+919588925771" className="inline-flex items-center justify-center gap-2 h-12 px-6 rounded-full gradient-hero text-primary-foreground font-medium shadow-soft hover:shadow-elevated transition-shadow text-sm">
              <Phone className="w-5 h-5" /> Call 9588925771
            </a>
            <a href="https://wa.me/919588925771?text=Hi%2C%20I%20want%20to%20book%20an%20appointment" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 h-12 px-6 rounded-full border border-primary/30 text-primary hover:bg-primary/5 font-medium text-sm transition-colors">
